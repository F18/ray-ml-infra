...
- 🎯 Entry points to execute your program using `python -m <ray_ml_infra>` or `$ ray_ml_infra` with basic CLI argument parsing.
...
Awesome ray_ml_infra created by F18

## Install it from PyPI

```bash
pip install ray_ml_infra
```
